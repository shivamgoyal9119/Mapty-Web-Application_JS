...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          alert("We Don't Get The Location");
        }
      );
    }
  }
  ...
  _loadMap(position) {
    ...
    console.log(
      `https://www.google.com/maps/@${latitude},${longitude},15.21z?entry=ttu`
    );
  ...
  _getLocalStorage() {
    ...
    // NOTE!!!
    // When we converted our object to a string and then back from the string to objects we lost the prototype chain.
